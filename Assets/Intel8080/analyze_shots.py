#!/usr/bin/env python3
"""Analyze shot handler code differences to understand Teflon shot behavior."""
...
# Shot handlers
disasm(0x05E9, 0x0650, "SquigglyShotHandler ($05E9)")
disasm(0x0617, 0x0680, "PlungerShotHandler ($0617)")
disasm(0x0644, 0x06C0, "RollingShotHandler ($0644)")

# ShotCollision / player shot hit check
disasm(0x03BB, 0x0440, "PlayerShotHandler ($03BB)")

# Shot-vs-shot collision area
disasm(0x0798, 0x0830, "TimeToFire / ShotCollision ($0798)")

# Look at specific addresses related to "blow up" behavior
# When player shot hits alien shot, the key question is:
# Does the Rolling shot skip the collision check?
disasm(0x0690, 0x06E0, "Shot collision check area ($0690)")
